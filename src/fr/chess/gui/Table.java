...
import fr.chess.engine.board.moves.MoveTransition;
import fr.chess.engine.board.moves.MoveUtils;
import fr.chess.engine.pieces.Piece;
import fr.chess.engine.player.Player;
import fr.chess.engine.player.ai.StandardBoardEvaluator;
import fr.chess.engine.player.ai.StockAlphaBeta;
import fr.chess.pgn.FenUtilities;
import fr.chess.pgn.MySqlGamePersistence;
...
import static fr.chess.pgn.PGNUtilities.persistPGNFile;
import static fr.chess.pgn.PGNUtilities.writeGameToPGNFile;
...
public class Table extends Observable {
    ...
    enum BoardDirection {
        NORMAL {
            @Override
            ArrayList<TilePanel> traverse(final ArrayList<TilePanel> boardTiles) {
                return boardTiles;
            }
        ...
        FLIPPED {
            @Override
            ArrayList<TilePanel> traverse(final ArrayList<TilePanel> boardTiles) {
                return (ArrayList<TilePanel>) Lists.reverse(boardTiles);
            }
            ...
            if(board.getPiece(this.tileId) != null) {
                try{
                    final BufferedImage image = ImageIO.read(new File(pieceIconPath +
                            board.getPiece(this.tileId).getPieceAllegiance().toString() + "_" +
